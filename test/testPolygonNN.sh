...
./datagenerator/generatePolygons.py 0 0 1000 1000 20000 15 3 > tmpData/dataset1.tsv
./datagenerator/generatePolygons.py 0 0 1000 1000 30000 15 3 > tmpData/dataset2.tsv
...
../build/bin/compute_partition_size 400 1.0 ${total_size} ${object_count} > tmpData/partition_size.cfg
