...
/* 
 * This program performs containment check on every object
 *  with the given window query
 * */
...
bool process_input(const int geom_idx, struct query_op &stop) {
	#ifdef DEBUG
...
int main(int argc, char **argv) {
	...
	process_input(stop.shape_idx_1, stop);
